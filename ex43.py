...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            You're running down the central corridor to the Weapons Armory when a Gothon jumps out, red scaly skin, dark grimy teeth and evil Clown costume flowing around his hate filled body.  He is blocking the door to the Armory and about to pull a weapon to blast you
            """))
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            You do a dive roll into the Weapon Armory, crouch and scan the room for more Gothons that might be hiding.  It;s dead quiet, too quiet.  You stand up and run to the far side of the room and fine the neutron bomb in its container.  There is a keypad lock on the box and you need the code to get the bomb out.  If you get the code wrong 10 times then the lock closes forever and you can't get the bomb.  The code is 3 digits
            """))
